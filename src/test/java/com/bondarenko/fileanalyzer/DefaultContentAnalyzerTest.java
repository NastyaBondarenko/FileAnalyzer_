...
public class DefaultContentAnalyzerTest {//extends AbstractContentAnalyzerTest
//    @Override
//    ContentAnalyzer getFileAnalyzer() {
//        return new DefaultContentAnalyzer();
//    }

    DefaultContentAnalyzer defaultContentAnalyzer = new DefaultContentAnalyzer();
    ...
    public void testReadContent() {
        ...
        String actualResult = defaultContentAnalyzer.readContent(path);
    ...
    public void testSplitIntoSentences_WithValidSeparators() {
        ...
        List<String> actualResult = defaultContentAnalyzer.splitIntoSentences(content);
    ...
    public void whenSearchSentences_BySearchedWord_thanSentencesWithThisWord_IsReturned() {
        ...
        List<String> actualSentences = defaultContentAnalyzer.filter(initialSentences, word);
    ...
    public void whenCountSearchWord_inContextWithOneSearchedWord_thanOneReturned() {
        ...
        int expectedCount = 1;
        int actualCount = defaultContentAnalyzer.countWords(initialSentences, word);
    ...
    public void whenAnalyzeFileWithNotExistingPath_thanNullPointerException_Returned() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            String path = null;
            String word = "duck";
            defaultContentAnalyzer.analyze(word, path);
        });
    }
    ...
    public void testAnalyzeContent_whenSearchedWordExistInContent() {
        String word = "duck";
        ContentInformation result = defaultContentAnalyzer.analyze(path, word);
