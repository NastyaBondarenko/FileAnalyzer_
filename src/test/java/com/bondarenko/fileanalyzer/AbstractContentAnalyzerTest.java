...
public abstract class AbstractContentAnalyzerTest {
//    ContentAnalyzer contentAnalyzer = getFileAnalyzer();
//
//    abstract ContentAnalyzer getFileAnalyzer();
//
...
//        String actualResult = contentAnalyzer.readContent(path);
//
...
//        List<String> actualResult = contentAnalyzer.splitIntoSentences(content);
//
//        assertEquals(expectedResult, actualResult);
//    }
//
...
//        List<String> actualSentences = contentAnalyzer.filter(initialSentences, word);
//
...
//
//        int expectedCount = 1;
//        int actualCount = contentAnalyzer.countWords(initialSentences, word);
//
...
//            String path = null;
//            String word = "duck";
//            contentAnalyzer.analyze(word, path);
//        });
//    }
//
//    @Test
...
//        String word = "duck";
//        ContentInformation result = contentAnalyzer.analyze(path, word);
//
//        int expectedCount = 3;
